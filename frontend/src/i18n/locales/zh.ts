export default {
  ...
  availableChannels: {
    ...
    searchModelPlaceholder: '模糊搜索模型、渠道、分组...',
    modelsTitle: '全部可用模型',
    modelsDescription: '查看所有可用的 AI 模型、可访问分组与当前计费方式。',
    modelCount: '共 {count} 个模型',
    cardView: '卡片视图',
    tableView: '表格视图',
    copyModel: '复制模型名',
    modelCopied: '模型名已复制',
    modelCardDescription: '{channel} 提供的 {platform} 模型。',
    noMatchedModels: '没有匹配的模型',
    empty: '暂无可用渠道',
    noModels: '未配置模型',
    noPricing: '未配置定价',
    exclusive: '专属',
